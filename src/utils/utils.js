...
//   const [error, value] = userStorage.get('token');
//   return !!value
// }
...
export function imageHandle(url, width, height) {
  return url.replace(/imageView2\/\d*\/w\/\d*\/h\/\d*/, `imageView2/1/w/${width}/h/${height}`)
}
